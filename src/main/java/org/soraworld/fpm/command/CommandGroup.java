...
public class CommandGroup extends AvalonCommand {
    ...
    protected CommandGroup(String name, String... aliases) {
        ...
        addSub(new AvalonCommand("create") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 1) {
                    ...
                    if (name != null && !name.isEmpty() && name.matches("[0-9a-zA-Z_]+") && !permManager.hasGroup(name)) {
                        permManager.setGroup(name, new Permission());
        ...
        addSub(new AvalonCommand("delete") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 1) {
                    permManager.removeGroup(args.get(0));
        ...
        addSub(new AvalonCommand("setparent", "setpa") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 2) {
                    permManager.getGroup(args.get(0)).moveTo(args.get(1));
        ...
        addSub(new AvalonCommand("delparent", "delpa") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 1) {
                    permManager.getGroup(args.get(0)).moveTo(null);
        ...
        addSub(new AvalonCommand("addsub") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 2) {
                    permManager.getGroup(args.get(0)).addSub(args.get(1));
        ...
        addSub(new AvalonCommand("delsub") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 2) {
                    permManager.getGroup(args.get(0)).removeSub(args.get(1));
        ...
        addSub(new AvalonCommand("setvalue", "setv") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 3) {
                    permManager.getGroup(args.get(0)).setValue(args.get(1), args.get(2));
        ...
        addSub(new AvalonCommand("delvalue", "delv") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 2) {
                    permManager.getGroup(args.get(0)).delValue(args.get(1));
        ...
        addSub(new AvalonCommand("save") {
            ...
            public void execute(ICommandSender sender, ArrayList<String> args) {
                if (args.size() == 1) {
                    ForgePermAPI.getPermManager().saveGroup(args.get(0));
